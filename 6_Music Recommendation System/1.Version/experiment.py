...
df = pd.read_csv("OUTPUT10.txt", sep='|',header=None ,names=['UserID','TrackId','AlbumId','ArtistId','Track','Genre1','Genre2','Genre3','Genre4','Genre5','Genre6'])
df.to_csv("83_features.csv")
